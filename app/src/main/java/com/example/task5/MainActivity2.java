...
public class MainActivity2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        switch (str) {
            ...
            case "Мясные продукты":
                products2 = getResources().getStringArray(R.array.meat);
                break;
            default:
                products2 = getResources().getStringArray(R.array.shop);
        }
    ...
    public void third(View view) {
        Intent third_intent = new Intent(MainActivity2.this, ActivityScroll.class);
        startActivity(third_intent);
    }

    public void fifth(View view) {
        Intent fifth_intent = new Intent(MainActivity2.this, ActivitySpinner.class);
